<?php namespace App\Http\Controllers;
	...
	class AdminOurclientController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Excerpt','name'=>'excerpt','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
